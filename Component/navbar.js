function navbar() {
  ...
  <a style="margin-left: 27px;cursor:pointer;" href="../HTML/home.html" class="logo"> <img src="../IMAGES/Logo/myntra.svg" alt="brandLogo" id="landingPage"></a>
<nav>
  <ul class="menu-items">
    <li>
      <a href="../HTML/menHomePage.html" class="menu-item-1">MEN</a>
      <div class="mega-menu">
        <div class="content">
          <div class="col">
            <section>
